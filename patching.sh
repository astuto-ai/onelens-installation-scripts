...
helm upgrade onelens-agent onelens/onelens-agent \
  ...
  --set prometheus.configmapReload.prometheus.resources.requests.cpu="$KSM_CPU_REQUEST" \
  --set prometheus.configmapReload.prometheus.resources.requests.memory="$KSM_MEMORY_REQUEST" \
  --set prometheus.configmapReload.prometheus.resources.limits.cpu="$KSM_CPU_LIMIT" \
  --set prometheus.configmapReload.prometheus.resources.limits.memory="$KSM_MEMORY_LIMIT" \
