...
if [ "$TOTAL_PODS" -lt 100 ]; then
    ...
    OPENCOST_CPU_LIMIT="115m"
    OPENCOST_MEMORY_LIMIT="196Mi"
    
    # OneLens Agent resources
    ONELENS_CPU_REQUEST="345m"
    ONELENS_MEMORY_REQUEST="161Mi"
    ONELENS_CPU_LIMIT="345m"
